 ...
 * Write a program that reads in investemtn amount, ammual interest rate
 * and number of years and display the future investment value using the following 
 * formula:
 * futureInvestmentValue = investmentAmount * (1 + monthlyInterestRate) ** Number of years
 *
 * **/
